...
class SimulationOrchestrator:
    ...
    def start_simulation(
        ...
        patient_profile = self._generate_patient_profile(specialty, difficulty)

        case_id = str(uuid.uuid4())

        # Generate initial patient greeting
        initial_greeting = self.patient_agent.generate_initial_greeting(
    ...
    def _generate_patient_profile(
        ...
        """Generate patient profile - integrates with RAG system."""
